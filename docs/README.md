...
| `payment_method`         | No            | [payment_method](#paymentmethod-object)                | Use this to provide the payment method details such as billing address, cardholder name, etc, when confirming the payment. See **payment_method object properties**                                                                                                                                                                            |
| `payment_method_options` | No            | [payment_method_options](#paymentmethodoptions-object) | Use this to provide the payment method options such as auto capture flag when confirming the payment. See **payment_method_options object properties**                                                                                                                                                                                         |
