...
| `onCancel`                    | Triggered when the shopper clicks the Cancel button when using GooglePay.                                                                                                          |
...
| `onClickConfirmButton`                     | Triggered when the shopper confirms a payment with card (either through created consent or by typing the entire card information).                                                                                                                                                     |
