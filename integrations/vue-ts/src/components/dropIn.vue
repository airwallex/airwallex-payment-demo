<!--
  ...
  Detailed guidance here: https://www.airwallex.com/docs/js/payments/dropin
-->
<template>
  <div>
    <h2>DropIn integration</h2>
    <!-- Example below: loading state when element is not yet mounted -->
    <p id="loading" class="dropInContainer">Loading...</p>
    <!-- Example: response message container -->
    <p id="error" style="display: none" class="dropInContainer" />
    <!-- 
    ...
    -->
    <div id="dropIn" :style="{ display: 'none' }" class="dropInContainer" />
  </div>
</template>
